...
const srcPath = 'C:\\Users\\Hafiz\\.gemini\\antigravity\\brain\\2cf5ee0e-55b2-418e-875b-74b6ecaddda7\\gta_6_system_reqs_1784544079766.png';
const destDir = path.join(__dirname, '../public/images/tech');
const destPath = path.join(destDir, 'gta-6-system-requirements.webp');
