...
import { characterApplication } from '../../../../backend-foundation/src/application/character.application';
import { locationApplication } from '../../../../backend-foundation/src/application/location.application';
import { vehicleApplication } from '../../../../backend-foundation/src/application/vehicle.application';
import { weaponApplication } from '../../../../backend-foundation/src/application/weapon.application';
import { businessApplication } from '../../../../backend-foundation/src/application/business.application';
