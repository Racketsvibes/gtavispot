...
const faqs = [
  ...
  },
  {
    ...
    a: 'While official retail prices are not yet announced, standard next-gen editions are expected to start at $69.99 USD, with premium Special and Collector’s editions available at higher price points.',
  },
];
        ...
        <div className={`container ${styles.heroInner}`}>
          <div className={styles.heroContent}>
            ...
            <div className={styles.heroWishlist}>
              <span className={styles.wishlistLabel}>Wishlist Now</span>
              <a
