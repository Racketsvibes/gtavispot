...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://gtavispot.com/story/${slug}/`,
    },
    openGraph: {
      title: article.title,
      description: article.metaDescription,
      url: `https://gtavispot.com/story/${slug}/`,
      type: 'article',
      images: [
        {
          url: imageUrl,
...
export default async function StoryArticlePage({ params }: Props) {
  ...
  const breadcrumbs = getBreadcrumbsSchema([
    ...
    { name: article.h1, url: `https://gtavispot.com/story/${slug}/` }
  ]);
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <article className={`container ${styles.article}`}>
        ...
        <ShareButtons url={`https://gtavispot.com/story/${slug}/`} title={article.title} isTop />
        ...
        <ShareButtons url={`https://gtavispot.com/story/${slug}/`} title={article.title} />
