...
const socialLinks = [
  { label: 'Twitter / X', href: 'https://twitter.com/', iconKey: 'x' },
  { label: 'YouTube', href: 'https://youtube.com/', iconKey: 'youtube' },
  { label: 'Instagram', href: 'https://instagram.com/', iconKey: 'instagram' },
  { label: 'TikTok', href: 'https://tiktok.com/', iconKey: 'tiktok' },
  { label: 'Discord', href: 'https://discord.gg/', iconKey: 'discord' },
  { label: 'Reddit', href: 'https://reddit.com/', iconKey: 'reddit' },
