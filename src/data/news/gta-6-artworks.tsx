  ...
  content: (
    <ImageLightbox>
      ...
      <p>
        ...
        With the console release planned for next year, these assets give the community a clear standard of what to expect in terms of character models and art style, aligning with the gameplay elements analyzed in our <Link href="/gta-6-gameplay/">GTA 6 gameplay</Link> breakdown. 
        Make sure to bookmark this page to download new official <strong>GTA 6 Artworks</strong> as they launch, or read our guide on how to design custom decals for your <Link href="/news/rockstar-crews/">Rockstar Crews</Link> in GTA Online.
      </p>
