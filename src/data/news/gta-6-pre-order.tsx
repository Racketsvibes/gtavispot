...
export const gta6PreOrder: ArticleData = {
  ...
  content: (
    <>
      ...
      <p>
        Pre-orders for GTA 6 started on <strong>June 25, 2026</strong>. Rockstar Games made the official announcement, locking in the pre-order launch across major digital platforms and brick-and-mortar storefronts. You can purchase the game digitally, check the digital bonuses of the <Link href="/news/gta-6-deluxe-edition/">gta 6 deluxe edition</Link> package, or reserve a <Link href="/news/gta-6-physical-copy/">gta 6 physical copy</Link> at local gaming retailers.
      </p>
      <p>
