    ...
    <>
      ...
      <div className={styles.quickAnswer}>
        ...
        <ul className={styles.quickAnswerList}>
          ...
          <li className={styles.quickAnswerItem}>
            <span className={styles.quickAnswerDot}>•</span>
            <span><strong>Authority Source:</strong> Game achievement databases and 100% completion trackers.</span>
          </li>
        </ul>
      </div>
      ...
      <p>
        The game features 42 stranger missions (the equivalent of "Strangers and Freaks" in previous entries) and over 90 dynamic random encounters. This optional content is distributed across the city districts, agricultural outposts, and keys.
      </p>
      <p>
        Completing these side missions is critical for players aiming for 100% completion. While certain tasks are simple delivery runs, others feature complex story arcs that expand on the history and culture of Leonida.
      </p>
      <p>
        For a guide to the main story chapters and how they connect to these side activities, see our <Link href="/story/walkthrough/">GTA 6 story walkthrough</Link>.
      </p>

      <h2>Stranger Tasks: Leonida's Weirdest Residents</h2>
      <p>
        Stranger missions are marked on the map by a question mark (?) when you approach their location. These missions are character-specific, requiring you to play as either Jason or Lucia to trigger them:
      </p>
      <ul>
      ...
      <p>
        During Act 2, you'll unlock assassination contracts from a contact operating in Downtown Vice City. These missions require you to eliminate corrupt corporate figures, stock manipulators, and rival cartel bosses:
      </p>
      <table>
        <thead>
          <tr>
      ...
      <p>
        The table shows the main assassination contracts and their locations. Completing these hits alters the stock market prices, allowing players to purchase shares before launching the mission to maximize their returns.
      </p>
      <p>
      ...
      <h2>Random Events: Dynamic Roadside Encounters</h2>
      <p>
        As you explore the state, the mini-map will flash red and blue, indicating an active random event. These encounters occur dynamically and do not require you to visit a specific icon:
      </p>
      <p>
        Common events include convenience store robberies in progress, where you can choose to help the clerk or rob the vault yourself. You'll also encounter crashed drug runner planes in the swamps, yielding cash parcels if you defeat the local guard units.
      </p>
      <p>
        Helping certain NPCs during these random encounters unlocks them as heist crew contacts. For example, rescuing a driver from a police convoy makes them available as an elite getaway driver for future bank runs.
      </p>
      <p>
        These events make the state feel alive, encouraging players to explore the backroads of Kelly County instead of using fast travel.
      </p>

      <h2>Are Side Missions Missable in GTA 6?</h2>
      <p>
        The majority of stranger quests can be completed after finishing the main story. However, four specific biker delivery missions in Act 2 must be completed before starting Mission 48, as the contact becomes unavailable in later chapters due to story events.
      </p>
      <p>
      ...
      <div className={styles.callout}>
        ...
        <p>
          GTA 6 features 42 stranger missions and 90+ random events. Completing stranger quests is required for 100% completion and unlocks heist crew contacts. Assassination contracts offer high payouts and alter stock market values.
        </p>
      </div>
